        ...
        <div>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-16 w-[90%] mx-auto'>
                <div className='col-span-1 lg:col-span-1'>
                    ...
                    <p className='font-normal text-base text-[#0B0B0B]  mb-3'>We're here to help! Fill out the form or reach us via email or phone. Our Customer Care Team is available to help you get the best experience out of Gadget Heaven whether you have an issue about your order or looking for helpful gadget tips.</p>
